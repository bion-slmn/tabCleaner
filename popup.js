...
function loadSettings() {
  chrome.storage.sync.get(
    ["maxTabs", "inactiveTabColor", "extraTabColor", "inactivityTime"],
    (result) => {
      document.getElementById("maxTabs").value = result.maxTabs || 10;
      document.getElementById("inactiveTabColor").value =
        result.inactiveTabColor || "grey";
      document.getElementById("extraTabColor").value =
        result.extraTabColor || "blue";
      document.getElementById("inactivityTime").value =
        result.inactivityTime || 5;
    }
  );
}
